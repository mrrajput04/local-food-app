...
export default function Hero() {
    ...
    return (
        <section className="relative bg-farm-green-dark text-white overflow-hidden">
            ...
            <div className="container relative z-10 py-20 md:py-32 flex flex-col items-center text-center">
                <div className="absolute top-4 right-4">
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="sm" className="text-white bg-white/20 hover:bg-white/30 flex items-center gap-2">
                ...
                <div className="w-full max-w-md relative">
                    <Input
                        ...
                        className="w-full pl-10 pr-32 py-6 text-foreground"
                        value={searchLocation}
                        onChange={(e) => setSearchLocation(e.target.value)}
                    />
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                    <Button className="absolute right-1 top-1/2 -translate-y-1/2 bg-farm-green hover:bg-farm-green-dark">
